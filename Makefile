...
ci-plugs-out-test:
	docker run \
		...
		golang:latest \
			/bin/bash -x -c "\
				./dist/chk-licenses_linux_amd64/chklicenses version && \
				./dist/chk-licenses_linux_amd64/chklicenses list github.com/khulnasoft/chk-licenses && \
				./dist/chk-licenses_linux_amd64/chklicenses check github.com/khulnasoft/chk-licenses \
			"

ci-test-linux-run:
	chmod 755 ./dist/chk-licenses_linux_amd64/chklicenses && \
	./dist/chk-licenses_linux_amd64/chklicenses version && \
	./dist/chk-licenses_linux_amd64/chklicenses list github.com/khulnasoft/chk-licenses

ci-test-linux-arm-run:
	chmod 755 ./dist/chk-licenses_linux_arm64/chklicenses && \
	./dist/chk-licenses_linux_arm64/chklicenses version && \
	./dist/chk-licenses_linux_arm64/chklicenses list github.com/khulnasoft/chk-licenses

ci-test-mac-run:
	chmod 755 ./dist/chk-licenses_darwin_amd64/chklicenses && \
	./dist/chk-licenses_darwin_amd64/chklicenses version && \
	./dist/chk-licenses_darwin_amd64/chklicenses list github.com/khulnasoft/chk-licenses

ci-test-mac-arm-run:
	chmod 755 ./dist/chk-licenses_darwin_arm64/chklicenses && \
	./dist/chk-licenses_darwin_arm64/chklicenses version && \
	./dist/chk-licenses_darwin_arm64/chklicenses list github.com/khulnasoft/chk-licenses
