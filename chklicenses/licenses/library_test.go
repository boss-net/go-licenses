...
func TestLibraries(t *testing.T) {
	...
	for _, test := range []struct {
	...
	}{
		{
			...
			importPath: "github.com/khulnasoft/chk-licenses/chklicenses/licenses/testdata/direct",
			wantLibs: []string{
				"github.com/khulnasoft/chk-licenses/chklicenses/licenses/testdata/direct",
				"github.com/khulnasoft/chk-licenses/chklicenses/licenses/testdata/indirect",
			},
		},
		{
			desc:       "Detects transitive dependency",
			importPath: "github.com/khulnasoft/chk-licenses/chklicenses/licenses/testdata",
			wantLibs: []string{
				"github.com/khulnasoft/chk-licenses/chklicenses/licenses/testdata",
				"github.com/khulnasoft/chk-licenses/chklicenses/licenses/testdata/direct",
				"github.com/khulnasoft/chk-licenses/chklicenses/licenses/testdata/indirect",
			},
		},
		{
			...
			importPath: "github.com/khulnasoft/chk-licenses/chklicenses/licenses/testdata/tags",
			goflags:    "-tags=tags",
			wantLibs: []string{
				"github.com/khulnasoft/chk-licenses/chklicenses/licenses/testdata/tags",
				"github.com/khulnasoft/chk-licenses/chklicenses/licenses/testdata/indirect",
			},
		},
	} {
